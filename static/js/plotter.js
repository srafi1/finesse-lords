...
var zip = function(){
    ...
    g.selectAll('path')
        ...
        .attr('fill-opacity', function(d) {
            return zip_data[d.properties.postalcode]/4239
    })
        .attr('d', geoPath);
};

var indiv_btn = document.getElementById("dots");
zoomer.addEventListener("click", indiv );
var zip_btn = document.getElementById("zip");
zoomer.addEventListener("click", zip);
